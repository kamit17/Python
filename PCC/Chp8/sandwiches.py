...
as the function call provides, and it should print a summary of the sandwich that
...
make_sandwich('lettuce','tomatoes','turkey breast')
make_sandwich('lettuce','tomatoes','turkey breast','pepper jack','Mayo')

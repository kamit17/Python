...
#randomQuizGenerator.py - Creates quizzes with question and  #ansewrs in random order ,
#along with answer key.


import random

#quiz data. Keys are states and their values are their capitals.

capitals = {'Alabama': 'Montgomery', 'Alaska': 'Juneau', 'Arizona': 'Phoenix', 'Arkansas': 'Little Rock', 'California': 'Sacramento', 'Colorado': 'Denver', 'Connecticut': 'Hartford', 'Delaware':
'Dover', 'Florida': 'Tallahassee', 'Georgia': 'Atlanta', 'Hawaii': 'Honolulu', 'Idaho': 'Boise',
...
'Carson City', 'New Hampshire': 'Concord', 'New Jersey': 'Trenton',  'New Mexico': 'Santa Fe', 'New York': 'Albany', 'North Carolina': 'Raleigh', 'North Dakota': 'Bismarck', 'Ohio': 'Columbus',
...
for quizNum in range(35):
      ...
      # Loop through the 50 states, making a question for each.
